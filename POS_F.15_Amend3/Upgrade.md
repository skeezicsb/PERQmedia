...
system from Amendment 1 to Amendment 3.  For _PERQemu_ users, the bundled hard
...
in the _PERQemu_ distribution set.  If you are still running the initial release,
...
For _PERQemu_, you can use either format; for updating your PERQ's hard disk
...
the upgrade scripts `am3bin.cmd` and `am3src.cmd`.  For _PERQemu_ users, be
